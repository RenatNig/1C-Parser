...
namespace Diplom1 {
    ...
    public partial class Компетенции_и_КоDataSet : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/Компетенции_и_КоDataSet6.xsd";
        ...
        public partial class CompetencDataTable : global::System.Data.TypedTableBase<CompetencRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public CompetencRow AddCompetencRow(string Наименование, string ВУЗ, string ФИО_студента, string Содержание) {
        ...
        public partial class InfoDataTable : global::System.Data.TypedTableBase<InfoRow> {
            ...
            private void InitClass() {
                ...
                this.columnФорма_обучения.MaxLength = 7;
            }
...
namespace Diplom1.Компетенции_и_КоDataSetTableAdapters {
    ...
    public partial class CompetencTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Competenc] WHERE (([№] = @p2) AND ((@IsNull_Наименование = 1 AND [Наименование] IS NULL) OR ([Наименование] = @Original_Наименование)) AND ((@IsNull_ВУЗ = 1 AND [ВУЗ] IS NULL) OR ([ВУЗ] = @Original_ВУЗ)) AND ((@IsNull_ФИО_студента = 1 AND [ФИО студента] IS NULL) OR ([ФИО студента] = @Original_ФИО_студента)) AND ((@IsNull_Содержание = 1 AND [Содержание] IS NULL) OR ([Содержание] = @Original_Содержание)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Competenc] ([Наименование], [ВУЗ], [ФИО студента], [Содержание" +
                "]) VALUES (@Наименование, @ВУЗ, @ФИО_студента, @Содержание);\r\nSELECT [№], Наимен" +
                "ование, ВУЗ, [ФИО студента], Содержание FROM Competenc WHERE ([№] = SCOPE_IDENTI" +
                "TY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Competenc] SET [Наименование] = @Наименование, [ВУЗ] = @ВУЗ, [ФИО студента] = @ФИО_студента, [Содержание] = @Содержание WHERE (([№] = @p2) AND ((@IsNull_Наименование = 1 AND [Наименование] IS NULL) OR ([Наименование] = @Original_Наименование)) AND ((@IsNull_ВУЗ = 1 AND [ВУЗ] IS NULL) OR ([ВУЗ] = @Original_ВУЗ)) AND ((@IsNull_ФИО_студента = 1 AND [ФИО студента] IS NULL) OR ([ФИО студента] = @Original_ФИО_студента)) AND ((@IsNull_Содержание = 1 AND [Содержание] IS NULL) OR ([Содержание] = @Original_Содержание)));
SELECT [№], Наименование, ВУЗ, [ФИО студента], Содержание FROM Competenc WHERE ([№] = @_)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT [№], Наименование, ВУЗ, [ФИО студента], Содержание FROM dbo.Competenc";
        ...
        public virtual int Delete(int p2, string Original_Наименование, string Original_ВУЗ, string Original_ФИО_студента, string Original_Содержание) {
        ...
        public virtual int Insert(string Наименование, string ВУЗ, string ФИО_студента, string Содержание) {
        ...
        public virtual int Update(string Наименование, string ВУЗ, string ФИО_студента, string Содержание, int p2, string Original_Наименование, string Original_ВУЗ, string Original_ФИО_студента, string Original_Содержание, int _) {
            if ((Наименование == null)) {
            ...
            if ((Original_ВУЗ == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[8].Value = ((string)(Original_ВУЗ));
            }
            if ((Original_ФИО_студента == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Наименование, string ВУЗ, string ФИО_студента, string Содержание, int p2, string Original_Наименование, string Original_ВУЗ, string Original_ФИО_студента, string Original_Содержание) {
            return this.Update(Наименование, ВУЗ, ФИО_студента, Содержание, p2, Original_Наименование, Original_ВУЗ, Original_ФИО_студента, Original_Содержание, p2);
        }
    }
