...
namespace Diplom1 {
    ...
    public partial class Компетенции_и_КоDataSet : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/Компетенции_и_КоDataSet.xsd";
        ...
        public partial class Table_1DataTable : global::System.Data.TypedTableBase<Table_1Row> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public Table_1Row AddTable_1Row(string Код, string Наименование_специальности, string ФИО_студента, string Год_начала_обучения, string Номер_курса, string Обьем_программы, string Форма_обучения) {
            ...
            private void InitClass() {
                ...
                this.columnНомер_курса = new global::System.Data.DataColumn("Номер курса", typeof(string), null, global::System.Data.MappingType.Element);
                ...
                this.columnНаименование_специальности.MaxLength = 40;
                this.columnФИО_студента.MaxLength = 30;
                this.columnГод_начала_обучения.MaxLength = 10;
                this.columnНомер_курса.MaxLength = 10;
        ...
        public partial class Table_1Row : global::System.Data.DataRow {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public string Номер_курса {
                get {
                    try {
                        return ((string)(this[this.tableTable_1.Номер_курсаColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'Номер курса\' в таблице \'Table_1\' равно DBNull.", e);
                    }
                }
                set {
                    this[this.tableTable_1.Номер_курсаColumn] = value;
                }
            }
            ...
            public bool IsНомер_курсаNull() {
                return this.IsNull(this.tableTable_1.Номер_курсаColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetНомер_курсаNull() {
                this[this.tableTable_1.Номер_курсаColumn] = global::System.Convert.DBNull;
            }
...
namespace Diplom1.Компетенции_и_КоDataSetTableAdapters {
    ...
    public partial class Table_1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Table_1] ([Код], [Наименование специальности], [ФИО студента], [Год начала обучения], [Номер курса], [Обьем программы], [Форма обучения]) VALUES (@Код, @Наименование_специальности, @ФИО_студента, @Год_начала_обучения, @Номер_курса, @Обьем_программы, @Форма_обучения)";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Номер_курса", global::System.Data.SqlDbType.NChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Номер курса", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Код, [Наименование специальности], [ФИО студента], [Год начала обучения], " +
                "[Номер курса], [Обьем программы], [Форма обучения] FROM dbo.Table_1";
        ...
        public virtual int Insert(string Код, string Наименование_специальности, string ФИО_студента, string Год_начала_обучения, string Номер_курса, string Обьем_программы, string Форма_обучения) {
            if ((Код == null)) {
            ...
            if ((Номер_курса == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[4].Value = ((string)(Номер_курса));
            }
