...
namespace Diplom1 {
    ...
    public partial class Компетенции_и_КоDataSet : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/Компетенции_и_КоDataSet3.xsd";
        ...
        public partial class CompetencDataTable : global::System.Data.TypedTableBase<CompetencRow> {
            ...
            private void InitClass() {
                ...
                this.columnСодержание.MaxLength = 200;
        ...
        public partial class InfoDataTable : global::System.Data.TypedTableBase<InfoRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public InfoRow AddInfoRow(string Код, string Наименование_специальности, string ФИО_студента, string Год_начала_обучения, string Номер_семестра, string Обьем_программы, string Форма_обучения) {
...
SELECT [№], Наименование, Содержание, ВУЗ, [ФИО студента] FROM Competenc WHERE ([№] = @_)";
    ...
    public partial class InfoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Info] ([Код], [Наименование специальности], [ФИО студента], [Год начала обучения], [Номер семестра], [Обьем программы], [Форма обучения]) VALUES (@Код, @Наименование_специальности, @ФИО_студента, @Год_начала_обучения, @Номер_семестра, @Обьем_программы, @Форма_обучения);
SELECT [№], Код, [Наименование специальности], [ФИО студента], [Год начала обучения], [Номер семестра], [Обьем программы], [Форма обучения] FROM Info WHERE ([№] = SCOPE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
...
SELECT [№], Код, [Наименование специальности], [ФИО студента], [Год начала обучения], [Номер семестра], [Обьем программы], [Форма обучения] FROM Info WHERE ([№] = @_)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT [№], Код, [Наименование специальности], [ФИО студента], [Год начала обучен" +
                "ия], [Номер семестра], [Обьем программы], [Форма обучения] FROM dbo.Info";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int p2, string Original_Код, string Original_Наименование_специальности, string Original_ФИО_студента, string Original_Год_начала_обучения, string Original_Номер_семестра, string Original_Обьем_программы, string Original_Форма_обучения) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(p2));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(string Код, string Наименование_специальности, string ФИО_студента, string Год_начала_обучения, string Номер_семестра, string Обьем_программы, string Форма_обучения) {
            if ((Код == null)) {
                this.Adapter.InsertCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
            else {
        ...
        public virtual int Update(
            ...
            if ((Original_Код == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[9].Value = ((string)(Original_Код));
            }
            if ((Original_Наименование_специальности == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[11].Value = ((string)(Original_Наименование_специальности));
            }
            if ((Original_ФИО_студента == null)) {
            ...
            if ((Original_Обьем_программы == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[19].Value = ((string)(Original_Обьем_программы));
            }
            if ((Original_Форма_обучения == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[21].Value = ((string)(Original_Форма_обучения));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Код, string Наименование_специальности, string ФИО_студента, string Год_начала_обучения, string Номер_семестра, string Обьем_программы, string Форма_обучения, int p2, string Original_Код, string Original_Наименование_специальности, string Original_ФИО_студента, string Original_Год_начала_обучения, string Original_Номер_семестра, string Original_Обьем_программы, string Original_Форма_обучения) {
            return this.Update(Код, Наименование_специальности, ФИО_студента, Год_начала_обучения, Номер_семестра, Обьем_программы, Форма_обучения, p2, Original_Код, Original_Наименование_специальности, Original_ФИО_студента, Original_Год_начала_обучения, Original_Номер_семестра, Original_Обьем_программы, Original_Форма_обучения, p2);
        }
    }
